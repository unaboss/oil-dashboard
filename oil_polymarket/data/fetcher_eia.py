...
from config import (
    ...
    CACHE_TTL_EIA, next_eia_release,
)

CACHE_KEY_CRUDE = "polymarket_eia_crude"
CACHE_KEY_GASOLINE = "polymarket_eia_gasoline"
CACHE_KEY_DISTILLATE = "polymarket_eia_distillate"
CACHE_KEY_RETAIL = "polymarket_eia_retail_gas"
